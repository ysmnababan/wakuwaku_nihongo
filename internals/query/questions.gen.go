...
func newQuestion(db *gorm.DB, opts ...gen.DOOption) question {
	...
	_question.QuestionID = field.NewString(tableName, "question_id")
	_question.CreatedAt = field.NewInt64(tableName, "created_at")
	_question.ModifiedAt = field.NewInt64(tableName, "modified_at")
	_question.DeletedAt = field.NewInt64(tableName, "deleted_at")
	_question.CreatedBy = field.NewString(tableName, "created_by")
	_question.ModifiedBy = field.NewString(tableName, "modified_by")
	_question.DeletedBy = field.NewString(tableName, "deleted_by")
	_question.QuizID = field.NewString(tableName, "quiz_id")
	_question.QuestionText = field.NewString(tableName, "question_text")
	_question.QuestionType = field.NewString(tableName, "question_type")
	_question.Quiz = questionBelongsToQuiz{
		db: db.Session(&gorm.Session{}),

		RelationField: field.NewRelation("Quiz", "model.Quiz"),
		Questions: struct {
			field.RelationField
		}{
			RelationField: field.NewRelation("Quiz.Questions", "model.Question"),
		},
	}

	_question.Answers = questionHasManyAnswers{
		db: db.Session(&gorm.Session{}),
...
type question struct {
	...
	Quiz         questionBelongsToQuiz

	Answers questionHasManyAnswers
...
func (q *question) updateTableName(table string) *question {
	...
	q.QuestionText = field.NewString(table, "question_text")
...
func (q *question) fillFieldMap() {
	...
	q.fieldMap["question_text"] = q.QuestionText
...
func (q question) clone(db *gorm.DB) question {
	...
	q.Quiz.db = db.Session(&gorm.Session{Initialized: true})
	q.Quiz.db.Statement.ConnPool = db.Statement.ConnPool
	q.Answers.db = db.Session(&gorm.Session{Initialized: true})
	q.Answers.db.Statement.ConnPool = db.Statement.ConnPool
	return q
}

func (q question) replaceDB(db *gorm.DB) question {
	q.questionDo.ReplaceDB(db)
	q.Quiz.db = db.Session(&gorm.Session{})
	q.Answers.db = db.Session(&gorm.Session{})
	return q
}

type questionBelongsToQuiz struct {
	db *gorm.DB
...
func (a questionBelongsToQuiz) Where(conds ...field.Expr) *questionBelongsToQuiz {
	if len(conds) == 0 {
		return &a
	}
...
func (a questionBelongsToQuiz) WithContext(ctx context.Context) *questionBelongsToQuiz {
	a.db = a.db.WithContext(ctx)
	return &a
}

func (a questionBelongsToQuiz) Session(session *gorm.Session) *questionBelongsToQuiz {
	a.db = a.db.Session(session)
	return &a
}

func (a questionBelongsToQuiz) Model(m *model.Question) *questionBelongsToQuizTx {
	return &questionBelongsToQuizTx{a.db.Model(m).Association(a.Name())}
}

func (a questionBelongsToQuiz) Unscoped() *questionBelongsToQuiz {
	a.db = a.db.Unscoped()
	return &a
}

type questionBelongsToQuizTx struct{ tx *gorm.Association }

func (a questionBelongsToQuizTx) Find() (result *model.Quiz, err error) {
	return result, a.tx.Find(&result)
}

func (a questionBelongsToQuizTx) Append(values ...*model.Quiz) (err error) {
...
func (a questionBelongsToQuizTx) Replace(values ...*model.Quiz) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a questionBelongsToQuizTx) Delete(values ...*model.Quiz) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a questionBelongsToQuizTx) Clear() error {
	return a.tx.Clear()
}

func (a questionBelongsToQuizTx) Count() int64 {
	return a.tx.Count()
}

func (a questionBelongsToQuizTx) Unscoped() *questionBelongsToQuizTx {
	a.tx = a.tx.Unscoped()
	return &a
}

type questionHasManyAnswers struct {
	db *gorm.DB

	field.RelationField
}

func (a questionHasManyAnswers) Where(conds ...field.Expr) *questionHasManyAnswers {
	if len(conds) == 0 {
		return &a
	}
...
func (a questionHasManyAnswers) WithContext(ctx context.Context) *questionHasManyAnswers {
	a.db = a.db.WithContext(ctx)
	return &a
}

func (a questionHasManyAnswers) Session(session *gorm.Session) *questionHasManyAnswers {
	a.db = a.db.Session(session)
	return &a
}

func (a questionHasManyAnswers) Model(m *model.Question) *questionHasManyAnswersTx {
	return &questionHasManyAnswersTx{a.db.Model(m).Association(a.Name())}
}

func (a questionHasManyAnswers) Unscoped() *questionHasManyAnswers {
	a.db = a.db.Unscoped()
	return &a
}

type questionHasManyAnswersTx struct{ tx *gorm.Association }

func (a questionHasManyAnswersTx) Find() (result []*model.Answer, err error) {
	return result, a.tx.Find(&result)
}

func (a questionHasManyAnswersTx) Append(values ...*model.Answer) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a questionHasManyAnswersTx) Replace(values ...*model.Answer) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a questionHasManyAnswersTx) Delete(values ...*model.Answer) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a questionHasManyAnswersTx) Clear() error {
	return a.tx.Clear()
}

func (a questionHasManyAnswersTx) Count() int64 {
	return a.tx.Count()
}

func (a questionHasManyAnswersTx) Unscoped() *questionHasManyAnswersTx {
	a.tx = a.tx.Unscoped()
	return &a
}
